      ...
      <aside className='hidden md:flex flex-col w-64 shadow-lg p-6'>
        ...
        <nav className='flex-1'>
          <ul className='space-y-2'>
            <li>
              <a
                className='flex items-center gap-2 px-4 py-2 rounded-lg text-blue-700 font-semibold'
                href='#'
              >
                Dashboard
              </a>
      ...
      <main className='flex-1 p-4 md:p-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mb-8'>
          ...
          <SummaryCard
            ...
            color='green'
          />
          <SummaryCard title='Orders' value='2590' percent='+' color='pink' />
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
          <div className='col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='bg-white rounded-xl shadow p-6'>
              ...
              <div className='flex justify-between mt-4'>
                <div>
                  ...
                  <span className='ml-2 text-green-500 text-xs'>▲ 2.87%</span>
            ...
            <div className='bg-white rounded-xl shadow p-6'>
              <h2 className='font-semibold text-lg mb-2'>Admins Overview</h2>
          ...
          <div className='grid grid-rows-2 gap-6'>
            ...
            <div className='bg-white rounded-xl shadow p-6'>
              <h2 className='font-semibold text-lg mb-2'>Platform Settings</h2>
              <div className='h-24 bg-gray-100 rounded' />
